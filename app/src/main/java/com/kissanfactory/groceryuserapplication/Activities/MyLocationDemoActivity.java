...
//                        .strokeWidth(5));
                map.addMarker(new MarkerOptions().position(punjab).title("Location"));
                map.moveCamera(CameraUpdateFactory.newLatLngZoom(punjab, 15f));
                ...
                map.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                    ...
                    public void onMapLongClick(@NonNull LatLng latLng) {
                        ...
                        intent.setClass(MyLocationDemoActivity.this, AddAddressActivity.class);

                        MyLocationDemoActivity.this.startActivity(intent);
